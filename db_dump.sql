...
--
-- Name: web_app_artist; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.web_app_artist OWNER TO postgres;

--
-- Name: web_app_artist_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.web_app_artist_id_seq OWNER TO postgres;

--
-- Name: web_app_artist_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: web_app_news; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.web_app_news OWNER TO postgres;

--
-- Name: web_app_news_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.web_app_news_id_seq OWNER TO postgres;

--
-- Name: web_app_news_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: web_app_artist id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: web_app_news id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
1	pbkdf2_sha256$260000$Fv8Umo3nhzRvnA7GN3Kvhq$/MdoP4FT6SH2i/cu6j8C8wx9tqHUSH1RBPDTwbJdF5g=	2021-08-28 19:06:29.829966+00	t	i.chepets			i.chepets@quantumobile.com	t	t	2021-08-28 19:06:20.598735+00
\.
...
clneo5rnjlogypyubpnl1y9k8ryae6ra	.eJxVjEEOwiAQRe_C2hCYMhVcuvcMZIBBqgaS0q6Md7dNutDtf-_9t_C0LsWvnWc_JXERWpx-t0DxyXUH6UH13mRsdZmnIHdFHrTLW0v8uh7u30GhXrY6owZEzmxxTGdjsnIAwDwo5bRFo6x1DtyQCfJmgQoUMJhsohoI9Cg-X8RUN0M:1mK3ev:fFhJfUAXBOap9GFTPEsC-x0X5BpixLQEwrzRYamB17c	2021-09-11 19:06:29.832575+00
\.


--
-- Data for Name: web_app_artist; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: web_app_artist_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Data for Name: web_app_news; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: web_app_news_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: web_app_artist web_app_artist_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: web_app_news web_app_news_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
